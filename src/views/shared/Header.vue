...
<template>
    <div class="flex flex-row gap-6 lg:gap-10 whitespace-nowrap mt-8 max-w-full overflow-hidden">
        ...
        <horizontal-menu-bar
            ...
            :items="{'Shop Resources':'/resources', 'GCSEs':'/gcse', 'A-Levels':'/a-level', 'Explore Bundles':'/bundles'}"
        >
            <template v-slot:shop-resources>
                ...
                <div v-else id="shop-resources"
                    ...
                    <div
                        ...
                        <div class="xl:w-1/3 mb-4 flex flex-col">
                            <h2>RESOURCE TYPE</h2>
                            <router-link :to="'/resources/explore?type='+type.slug" v-for="(type) in types">{{ type.name }}</router-link>
                        </div>
                        <!--
                        <div class="xl:w-1/3 mb-4 flex flex-col">
                            <h2>COLLECTION</h2>
                ...
                <div v-else
                    ...
                    <div class="flex flex-col md:flex-row md:flex-wrap md:col-span-2 xl:col-span-3">
                        <div class="flex flex-col w-1/2 lg:w-1/3">
                            <h2>RESOURCE TYPE</h2>
                            <router-link :to="'/resources/explore?level=gcse&type='+type.slug" v-for="(type) in types">{{ type.name }}</router-link>
                        </div>
                ...
                <div v-else
                    ...
                    <div class="flex flex-col md:flex-row md:flex-wrap md:col-span-2 xl:col-span-3">
                        <div class="flex flex-col w-1/2 lg:w-1/3">
                            ...
                            <a href="">EBooks</a>
                            -->
                            <router-link :to="'/resources/explore?level=a-level&type='+type.slug" v-for="(type) in types">{{ type.name }}</router-link>
                        </div>
                        <div class="bg-theme-lightteal w-1/2 lg:w-2/3 centered py-8 min-h-40">
                            <div class="flex flex-row -rotate-5">
        ...
        <div class="hidden sm:flex sm:flex-row sm:flex-nowrap justify-center items-center">
            <div class="rounded-full bg-theme-pale h-10 mb-8">
                ...
                <search-icon class="cursor-pointer inline mx-4 relative -top-1" width="16" height="16"
                             @click="performSearch"/>
            </div>
        </div>
        <div class="shrink mt-2 lg:mr-4">
