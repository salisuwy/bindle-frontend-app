...
<template>
  <Teleport to="body">
    <div @click="hideModal" class="fixed inset-0 w-screen h-screen bg-black opacity-30 z-20"></div>
    <section
      class="fixed top-1/2 right-1/2 translate-x-1/2 -translate-y-1/2 z-30 flex flex-col items-center pb-0 text-sm bg-white rounded-lg min-w-[350px] max-w-[400px] border"
    >
      <header
