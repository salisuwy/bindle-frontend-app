<template>
  <MinimalLayout>
    <div class="signup-container flex justify-center items-center">
      <div
        class="signup-box w-full max-w-md bg-white rounded-lg shadow-md text-left"
        @keydown.enter="onSignupUser"
      >
        ...
        <div class="p-6">
          ...
          <div class="mb-4 relative">
            ...
            >
              <i
                :class="isConfirmPasswordVisible ? 'fa fa-eye-slash' : 'fa fa-eye'"
                class="pt-2"
              ></i>
            </span>
          </div>
