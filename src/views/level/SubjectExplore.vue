                    ...
                    <accordion ref="filterSubjectAccordionRef"
                        ...
                        <div v-if="filtersLoaded"  class="radio-links">
                            <div v-for="listSubject in subjects">
                                <input :id="'filter-subject-'+listSubject['slug']" v-model="filterSubject" class="bindle-radio" type="radio" name="subject" :value="listSubject['slug']" @click="updateSubject(listSubject['slug'])"/>
                                <label :for="'filter-subject-'+listSubject['slug']" class="cursor-pointer mr-auto">{{ listSubject['name'] }}</label>
                            </div>
                        </div>
                    </accordion>
